            ...
            <div class="panel-body panel-header-right no-padding">
						...
						<div class="discount-container clearfix">
							...
							<div class="discount-left">
								...
								<p class="discount-left-value">	10% OFF</p>

							</div>

							<div class="discount-right">

				<span class="text-danger discount-right-title">10% Discount on Minimum Order $25.00</span>
				<p>( Apply Automatically )</p>
...
<center><div class="loader2"></div></center>
		 ...
		 <?php 
            ...
            <div class="total-row">
                ...
                <?php $_SESSION['utils']['sub_total']=($subTotal+$addonTotal);?>
           ...
           <div class="total-row">
            ...
            <div id="coupanMsg"></div>
                ...
                <div class="pull-left"><span class="lang-delivery-fee"><strong>Apply Coupan</strong></span>:</div>
               ...
               <input type="text" name="coupanCode" class="form-control"  id="coupanCode" placeholder="enter you coupan code"/>
          ...
          <input type="button" name="apply" id="apply" onClick="ValidateCoupan();" value="Apply Now" class="btn btn-primary" />
            ...
            <div class="big-total-row" id="big_total_scroll" >
	...
	<?php //if($_SESSION['utils']['restoOpenSt']==0){?>

		<!--<button class="btn btn-block btn-primary-custom btn-main-defined button-disable" id="cart-checkout" data-container="body" data-toggle="popover" data-placement="top" data-content="">Checkout</button>-->
  ...
  <a href="checkout.php" class="btn btn-block btn-primary btn-main-defined" id="cart-checkout" data-container="body">Checkout</a>   <?php // }?>

	<div class="cart_agrement">
		...
		<div class="cart_powered text-center">
